...
if (process.env.RELEASE_CONFIRM !== 'publish-0.1.1-alpha')
  throw new Error('release confirmation does not match publish-0.1.1-alpha');
...
console.log(
  'Published six AgenticFI packages as npm 0.1.1 alpha releases with provenance and no unintended latest tags.',
);
