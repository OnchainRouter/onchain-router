...
const binaries = [
  ['onchain-router', 'apps/buyer-cli/dist/index.js', ['--version'], '0.1.0'],
  ['onchain-router-mcp', 'apps/buyer-mcp/dist/index.js', ['--version'], '0.1.0'],
  ['onchain-router-proxy', 'apps/buyer-proxy/dist/index.js', ['--version'], '0.1.0'],
];
