...
This public alpha requires the matching `0.1.0` Buyer CLI. Check the canonical site's `/docs/installation`, `/products.json`, and the npm `alpha` dist-tag for publication facts. Reading this skill does not authorize wallet setup, import, funding, unlock, policy widening, or a paid call.
